    ...
    def sprav(self):
        messageBox = QMessageBox.information(self, self.tr("Справка"),
                                             self.tr("Разработчики: Майданюк Кирилл, Кулагина Лина, группа ПИ-19б \n\n"
                                                     "Продукт разработан с целью повышения эффективности труда "
                                                     "программистов. Программный продукт повышает скорость перевода чисел "
                                                     "из одной системы счисления в другую, автоматизирует данный процесс, "
                                                     "снижает стоимость программных продуктов за счет уменьшения количества "
                                                     "рабочих часов разработчиков, затрачиваемых на перевод чисел вручную. "
                                                     "\n\nПочта тех.поддержки: converterprogram
                                                     m@gmail.com"),
                                             QMessageBox.Ok)
